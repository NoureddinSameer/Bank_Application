...
/* Here I design and implement a class and name it "Withdrawal" and  I use the reserved word "extends" that refer to the inheritance and I define a subclass "Withdrawal" from a superclass "Transactions" */
public class Withdrawal extends Transactions{
    /* Constructors of Withdrawal class......... */
    /* Here I create the constructor of Withdrawal class (no-parameter) */
    public Withdrawal(){
        /* Here I use super() to invoke a superclass's constructors */
        super();
    }
    /* Here I create the constructor of Withdrawal class (two parameters), the first parameter is of type String, the second parameter is of type double */
    public Withdrawal(String Account_Number,double MoneyOfTransactions){
    ...
    /* Method(Action) of the Withdrawal class......... */
    ...
    public String toString(){
        ...
        return "The transaction type: Withdrawal ,The number of account: "+getA().getAccount_Number()+" , The amount of money: "+super.getMoneyOfTransactions()+"$ ,Date: "+super.getDatecreatedOfTransactions()+" ,"+Bank.printStatusOfOperation(Bank.getX().isCheckOfStatus());
    }
